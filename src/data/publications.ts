...
export const publications: Publication[] = [
  ...
  },
  {
    ...
    year: 2021,
    journal: "The Species–Area Relationship (Cambridge University Press)",
    doi: "10.1017/9781108569422.017",
  ...
  {
    id: 'lowndes-2019-nature-open-data',
    title: "Supercharge your research: a ten-week plan for open data science",
    authors: "Lowndes, Julia S. Stewart, Froehlich, Halley E., Horst, Allison, Jayasundara, Nishad, Pinsky, Malin L., Stier, Adrian C., Therkildsen, Nina O., Wood, Chelsea L.",
    year: 2019,
    journal: "Nature",
    ...
    openAccess: false,
    dataAvailable: false,
    pdfUrl: "https://drive.google.com/open?id=1CWoLmJ9HA1ca2m83Dawd5gjwV8wY7vNk&authuser=astier%40ucsb.edu&usp=drive_fs",
    citationCount: 0,
  },
  {
    id: '32',
  ...
  },
  {
    ...
    year: 2015,
    journal: "Mutualism (Oxford University Press)",
    doi: "10.1093/acprof:oso/9780199675654.003.0009",
  ...
  },
  {
    ...
    openAccess: false,
    dataAvailable: false,
    pdfUrl: "https://drive.google.com/open?id=1OhsvSLzo9wgVd7-9eC7kB1tqLNIeirYo&authuser=astier@ucsb.edu&usp=drive_fs",
    citationCount: 0,
  },
  {
    id: '61',
  ...
  {
    id: 'barbier-2011-treatise',
    title: "Estuarine and coastal ecosystems and their services",
    authors: "Barbier, Edward B., Hacker, Sally D., Koch, Evamaria W., Stier, Adrian C., Silliman, Brian R.",
    year: 2011,
    journal: "Treatise on Estuarine and Coastal Science (Elsevier)",
    doi: "10.1016/b978-0-12-374711-2.01206-7",
    themes: ["Research"],
    featured: false,
    openAccess: false,
    dataAvailable: false,
  ...
  {
    id: 'osenberg-2011-mpa-chapter',
    title: "Assessing effects of marine protected areas: confounding in space and possible solutions",
    authors: "Osenberg, Craig W., Shima, Jeffrey S., Miller, Sonja L., Stier, Adrian C.",
    year: 2011,
    journal: "Marine Protected Areas (Cambridge University Press)",
  ...
  },
  {
    ...
    abstract: "Increased habitat availability or quality can alter production of habitat-dependent organisms in two contrasting ways: by enhancing input of new colonists to the new sites (the Field-of-Dreams Hypothesis), or by drawing colonists away from existing sites (the Propagule Redirection Hypothesis), thus reducing the deleterious effects of density. We conducted a field experiment on coral reef fishes in Moorea, French Polynesia, to quantify how differing levels of habitat availability increased and/or redirected colonizing larval fish. Focal reefs without neighboring reefs received two to four times more settlers than reefs with adjacent habitat, demonstrating that increased habitat redirected larval fish. A recruitment model predicts that habitat addition increases recruitment primarily by ameliorating the negative effects of competition at existing sites.",
    themes: ["Coral"],
    featured: false,
    openAccess: false,
    dataAvailable: false,
