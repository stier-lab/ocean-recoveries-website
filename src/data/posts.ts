 ...
 * Generated: 2025-12-12T18:26:09.363Z
 * Total posts: 75
 *
...
## Key Findings
- 11 papers that sampled organismal or biomass density Before and After establishment of an MPA at sites both inside and outside of the MPA.
...
## Key Findings
- When the strength of predation shifts.- Two qualitatively different effects of increasing predatory fish abundance on coral area .- Under certain circumstances predators can in fact enhance the performance of multispecies mutualisms, with cascading impacts on the growth of foundation species.- The effect of predators on coexistence of their mutualists depends on mutualist competitive dynamics as well as the relative susceptibility mutualists have to predation.- Predators can have positive, negative, or little effect on the foundation species depending on the competitive interactions between mutualists, the relative susceptibility or mutualists to predation, and the benefits mutualists provide to the host.
...
## Key Findings
- Positive effects of temperature on metabolism and predation, but in contrast to our hypothesis, rising temperature caused lobster consumption rates to increase at a faster rate than increases in metabolic demand, suggesting that for the mid-range of temperatures, lobsters are capable of ramping up consumption rates to increase their caloric demand.- Temperature plays a key role in driving the geographic range of spiny lobsters and that spatial and temporal shifts in temperature can play a critical role in driving the strength of species interactions for a key predator in temperate reef ecosystems.- Little evidence for variation in attack rates between 16 and 26°C.- Metabolic, and predation rates increase as functions of temperature, but show that predation rates increased at a faster rate with temperature than metabolism.- Increases in temperature had very limited effect on attack rate, but that increases in temperature caused large increases in maximum consumption rates.
...
[Read the full paper](https://doi.org/10.1111/1365-2656.13918)`,
  },
  {
    ...
    date: "2023-05-01",
    author: "Curtis et al.",
    excerpt: "org/10.1007/s00338-023-02367-7 NOTE 3D photogrammetry improves measurement of growth and biodiversity patterns in branching corals Joseph S. Journ W. Alexander Craig W. Adrian C. Stier 1,2 © The...",
    featuredImage: "/images/tropical-island-aerial-view-lagoon-reef.jpeg",
    tags: ["Publication","Coral","2023"],
    content: `## Summary

org/10.1007/s00338-023-02367-7 NOTE 3D photogrammetry improves measurement of growth and biodiversity patterns in branching corals Joseph S. Journ W. Alexander Craig W. Adrian C. Stier 1,2 © The Author(s), under exclusive licence to International Coral Reef Society (ICRS) 2023

## Key Findings
- Photogrammetry-based estimates of colony skeletal volume best predicted the abundance and richness of animals living within the coral.- Our findings demonstrate that photogrammetry can yield useful descriptions of coral colony structure and growth, and quantify the value of its application over traditional measurement methods.- There were differences based upon , even at monthly timescales and across a wide range of colony sizes.
...
## Key Findings
- Dead coral skeletons could substantially diminish coral resilience if they provided macroalgae refuge from herbivory, a key feedback associated with the recovery of coral populations.- This outcome held when settlement onto dead coral was less than or equal to the rate of settlement on open substrate.- We showed that disturbances that leave dead skeletons (material legacies) can erode coral resilience, either prolonging the return to a coral-dominated state or causing a regime shift from a coral to a macroalgae community.- Better integration of material legacies into studies of resilience may offer key insight into when and where ecosystems that are dominated by structure-forming organisms will cross tipping points.- Material legacies hold the capacity to shape the landscape of resilience in which a system operates by determining the magnitude of hysteresis between a system variable and its driver.
...
## Key Findings
- No evidence for systematic differences in foraging rates by tank side.- Kelp degradation over 96 h was minimal relative to the accuracy of estimating the weight of kelp (~"2% error).- No evidence that the proportion of biomass lost as fronds and blades varied with standing kelp biomass or temperature .- That—like urchin biomass—historical kelp consumption is likely to have varied considerably.- No evidence for a nonlinear relationship between urchin biomass and consumptive capacity.
...
## Key Findings
- The interactive effects of global warming and changes infishing pressure in driving the most recent regime and document the existence of hysteresis.- Only 5 of the 55 papers reviewed mentioning the concepts of hysteresis and irreversibility.- We showed for thefirst time that the North Sea underwent a true, irreversible regime shift and that the community completely restructured after 2003.- Evidence that the regime shift has not reversed.
...
## Key Findings
- No relationship between human influence and resistance to disturbance and some evidence that areas with greater human development may recover from disturbance faster than their more isolated counterparts.- Reef remoteness does not enhance resilience to disturbance.- A positive correlation between HII and recovery rate.- Isolation from local human influence did not measurably affect coral community resilience to largescale disturbances such as bleaching, disease, storms, and predator outbreaks.- Significantly impact the response variable (recovery rate or resistance) with the magnitude of the effect represented by the “estimate” value and the direction of the effect given by the sign of the estimate value (positive or negative).
...
## Key Findings
- No statistical association between urbanization and freshwater and coastal marine ecosystem functions, estimated from changes in accumulated algal biomass on tiles (benthic net primary productivity) and loss of biomass from litter bags (decomposition).- The effects of urbanization can be complex and that attention to terrestrial, freshwater, and coastal marine systems in concert will produce more effective, ecosystem-based management.- Facilitated a strong test for associations between urbanization and ecosystem properties.- Urbanization effects were context-dependent.- Biodiversity is not uniformly lower , net primary productivity and decomposition ecosystem functions are not measurably different , and coastal marine habitats are not less affected than freshwater habitats by urbanization .
...
## Key Findings
- Nitrogen availability can produce a ‘‘Goldilocks effect”, in which too-low or too–high levels of nitrogen could increase the risk of host bleaching under light stress.- Results suggested that when hosts are stressed, nitrogen can be harmful if ‘‘too low” or ‘‘too high”, but beneficial if ‘‘just right”.- One case in which the presence of fish prevented the host from bleaching (when pulse magnitude was 39 mol photons m 2 d 1 and pulse duration was 25d).- Slightly increasing environmental nitrogen and decreasing the flushing rate (such that overall nitrogen availability was higher and fish excretions were lost at a slower rate) expanded the range of stress levels for which fish increased nitrogen into the ‘‘just right” ranges and prevented bleaching.- Some cases in which fish increased host bleaching tolerance.
...
## Key Findings
- Results showed that legal-sized lobster abundance in traps (catch per unit effort) increased by 125%–465% deep inside reserves, and by 223%–331% at sites near to reserve borders, and by nearly 400% just outside of reserve borders over the 10-year period, thus indicating asubstantial increase in spillover across reserve borders.- This study demonstrates how spillover scales with biomass buildup and that collaborative fisheries research can be used to assess the efficacy of marine reserves as fishery management tools worldwide.- The ratio of sublegals to legal lobsters increased for all trapping locations except three, the out-edge at both Gull and Scorpion, and the in-deep at Scorpion .- 15 years after reserves were established two key proxies for lobster population status and fishery performance.- Lobster populations may have doubled in size within reserves, and the rate of spillover may have quadrupled in the 10-year increment between 2008 and 2018.
...
## Key Findings
- Their direct impacts on survivorship and size distributions of one native prey species are similar to those of a native mesopredator.- Multiple predator species stalking and striking them.- Lionfish and native mesopredators feeding voraciously on these gobies in the field.- Our results demonstrate that lionfish are less common than native mesopredators in Caribbean Panama and beyond, but it is possible that lionfish impacts on native prey are greater (Albins2013; Ellis and Faletti2016).- Strong congruence in outcomes across trials, giving little reason to suspect that more replication would lead to different inferences.
...
## Key Findings
- Coral density and corallivory have strong but independent effects on coral performance.- No evidence for a predator pit, our results suggest that spatio-temporal variation in corallivore and coral densities can fundamentally alter population dynamics via strong effects on juvenile corals.- No evidence that the rate of corallivory was dependent on coral density.- Corallivores exerted strong negative effects on coral growth and survival at small colony sizes at a range of densities, corroborating other recent studies on corallivory.- For corals in high density treatments was likely a plastic, competitive response to maximize resource capture (Lang and Chornesky1990) and not a true density dependent increase in growth rate.
...
## Key Findings
- The percent cover of understory macroalgae was significantly higher in severe years than mild years.- The system was generally resilient to changes in storm intensity until very high intensities were reached.- Temporal variability in the abundance of a foundation species may influence diversity in a similar way: when foundation species are volatile, the resulting environmental heterogeneity can promote the coexistence of species with different resource requirements.- One consequence of this environmental heterogeneity is that it can promote the temporal coexistence of competitors.
...
## Key Findings
- Greater build-up of lobsters within MPAs relative to unprotected areas, and greater increases in fishing effort and total lobster catch, but not CPUE, in fishing zones containing MPAs vs.- A 35% reduction in fishing area resulting from MPA designation was compensated for by a 225% increase in total catch after 6-years, thus indicating at a local scale that the trade-off of fishing ground for no-fishing zones benefitted the fishery.- We report between fished and unfished areas.- By responding to the no-fishing zones by fishing near MPA borders, the fishery is experiencing a net benefit of no-fishing zones at a local scale.
...
## Key Findings
- Significant impacts on animal behaviour is by altering movement.
...
## Key Findings
- Dynamically optimizing harvest can minimize local risk without sacrificing yield.- Spatial mismatch among scales is not merely an esoteric concern.- The same spatial variation that leads to resilience at the metapopulation scale, when left unaccounted for in management strategies, can also produce unforeseen negative consequences in the form of magnified spatial variation and local risk of collapse.- Can contribute to spatial variation.- We demonstrate numerically and analytically that spatial variation is likely to increase with harvest.
...
## Key Findings
- We showed that the stability of understory algae and sessile invertebrates was positively and indirectly related to the stability of giant kelp, which primarily resulted from giant kelp’s direct positive association with species richness.- A positive relationship between the stability of the combined community of algae+invertebrates and the mean species richness in this taxonomically complex assemblage of reef organisms.- The relationship between community stability and giant kelp stability differed among the community types.- The stability of these two community types was more strongly related to the temporal standard deviation of giant kelp biomass.- Similar differences among community types with regard to the relationship between species richness and giant kelp stability.
...
## Key Findings
- Results suggest that purple urchin activity level and size jointly determine their susceptibility to predation by lobsters.- Slow‐ moving urchins were more likely to survive encounters with lobsters , whereas covering behavior did not predict urchin survival on its own.- Fast‐moving purple urchins were more likely to succumb to lobsters than sedentary urchins.- Urchin behavior may potentially play a role in driving the dynamics of kelp forest ecosystems at fine spatial scales.- Purple urchin size and behavioral tendencies syn‐ ergistically determined their susceptibility to predation by spiny lobsters, which are known predators of urchins in nature (Lafferty, 2004; Tegner & Levin, 1983).
...
## Key Findings
- These findings indicate that reefs are unlikely to achieve or remain in any static or historically informed“recovered”state.
...
## Key Findings
- Strong evidence for a metabolic scaling coefficient of 0.- We demonstrate how an evidentialist approach can be applied to gain novel insight to the question, “What is the evidence for an intraspecific universal scaling relationship between fish body mass and metabolic rate?” Scaling Relationships as Hypotheses for Fish Multiple mechanisms have been put forth to justifyβ= 0.- Our data show that fisheries models that blindly adopt this parameter may be ultimately misleading.
...
## Key Findings
- We report the results of each of the three analyses (gradient forest analysis, full GAM analyses, and truncated GAM analyses).- Our analysis reveals effects of both environmental and human pressures as major predictors of individual and aggregated ecosystem states in the CCS.- A range of magnitudes in the response of ecosystem states across the associated thresholds.- Two significant threshold relationships in the full GAM analyses with plausible mechanistic underpinnings.- We demonstrated how the MMI framework highlights potentially nonlinear ecosystem state–pressure relationships.
...
## Key Findings
- Results suggest priority effects are more important than colonizer abundance and should motivate the integration of priority effects into future studies of density dependence to determine their relative importance.- We showed that priority effects can have a larger influence on individual survival than the number of individuals arriving at a site.- A strong inhibitory priority effect—lemon damselfish arriving 3 h later than Ambon damselfish experienced depressed survival.- Significant impacts on the transient dynamics of ecological systems (Fukami and Nakajima2011).- There were differences on lemon damselfish mortality.
...
## Key Findings
- There were differences among the three groups.
...
## Key Findings
- The effects of small predators on coral reefs can be size-independent, suggesting that variation in predator sizestructure alone may not always affect the functional role of these predators.- 100% survivorship in both cases.- The presence of hawkfish on coral heads correlated with a lower probability of chromis and damselfish being present on coral heads; however, there was no difference in the probability of prey fish presence between corals with small and large hawkfish, as there was extensive overlap in the estimated mean predicted posterior probability of either prey fish species being present .- The functional responses of small and large hawkfish do not differ under experimental settings .- Hawkfish on December 7, 2016http://rsos.
...
## Key Findings
- The effects of predators on abundance, richness, Jaccard index of beta diversity, and the proposed rarefied Jaccard index.- The effects of sampling on beta diversity depends on the shape of the rank-abundance curve and whether beta diversity originates from common or rare species; and (3) we develop a new method to calculate rarefied beta diversity for two or more sets of patches, and use two cases that demonstrate its utility.- We showed that the positive effect of hawkfish on observed prey diversity persists for rarefied beta diversity, suggesting hawkfish positively affected beta diversity beyond affecting patch size.- For a per-patch population size of 20, the test is actually slightly conservative.
...
## Key Findings
- Results when juvenile plants have increasing probabilities of associating with B1, and adults have the same increasing probabilities of associating with B2.
...
## Key Findings
- Pervasive genotype by ecotype interactions at the community level, as four of the eight most common taxa showed significant interactions .- Intraspecific genotypic variation in black cottonwood often dictated the strength of top-down control by the presence of fish .- Similar interactive effects between fish and black cottonwood genotypes at the ecosystem level, also driven primarily by stronger top-down control when coupled with the most productive black cottonwood genotypes.- The addition of fish had an average Hedge’sgeffect size of 0.- Cottonwood genetic variation influenced tank-level productivity (GPP) over the course of the experiment.
...
## Key Findings
- Both flame hawkfish and coral crouchers substantially alter fish and crustacean community organization, and we discuss the implications of shifts in community structure for coral growth and resilience.- Coral couchers and flame hawkfish in 65 and 81 % of the 93 surveyed corals, respectively.- No effect of predator identity.- We showed novel effects of predatory fishes on the abundance, diversity, and composition of coraldwelling fishes and decapods.- There were differences of predators or interaction between predator density and identity for beta diversity based on species incidence or relative abundance, and there were no main effects of predator density or identity based on species relative abundance (ESM C).
...
## Key Findings
- Eggand adult-fishing have asymmetric effects on herring population dynamics - herring stocks can withstand higher levels of egg harvest before becoming depleted.- We report the mean of these 4 response variables across the simulations in www.
...
## Key Findings
- Independent effects of groupers and patch characteristics on prey communities.- Two different pathways.- No evidence of aggressive coloration, or any cooperative or antagonistic interactions in treatments where two groupers were present in the same cage; however, we do not know precisely whether groupers changed their foraging behavior in the presence of a second conspecific.- Increases in species richness (strongest in the absence of groupers) and substantial changes in species composition for fragmented patches relative to whole reefs.- Grouper-induced shifts in community structure, particularly an increase in damselfishes (planktivores) and decreases in surgeonfishes (herbivores) and gobies (benthic invertivores).
...
## Key Findings
- Body size does not affect regeneration in adult axolotls, but metamorphosis causes a twofold reduction in regeneration rate, and lead to carpal and digit malformations.- Preand postmetamorphic limb skeletons were both ossified.- Metamorphic and paedomorphic blastemas had a similar fraction of PCNA-positive cells.- Metamorphs had a smaller proportion of BrdU-positive cells (relative to total blastema cells) compared with paedomorphs.- Metamorphs had a twofold greater number of cells in the blastema.
...
Simulation models are widely used to represent the dynamics of ecological systems. A common question with such models is how changes to a parameter value or functional form in the model alter the results. Some authors have chosen to answer that question using frequentist statistical hypothesis tests (e.g. analysis). This is inappropriate for two reasons. First, p‐values are determined by statistical power (i.e. replication), which can be arbitrarily high in a simulation context, producing minuscule p‐values regardless of the effect size. Second, the null hypothesis of no difference between treatments (e.g. parameter values) is known a priori to be false, invalidating the premise of the test. Use of p‐values is troublesome (rather than simply irrelevant) because small p‐values lend a false sense of importance to observed differences. We argue that modelers should abandon this practice and focus on evaluating the magnitude of differences between simulations.SynthesisResearchers analyzing field or lab data often test ecological hypotheses using frequentist statistics (t‐tests, analysis, etc.) that focus on p‐values. Field and lab data usually have limited sample sizes, and p‐values are valuable for quantifying the probability of making incorrect inferences in that situation. However, modern ecologists increasingly rely on simulation models to address complex questions, and those who were trained in frequentist statistics often apply the hypothesis‐testing approach inappropriately to their simulation results. Our paper explains why p‐values are not informative for interpreting simulation models, and suggests better ways to evaluate the ecological significance of model results.

## Key Findings
- There were differences in the M, .
...
## Key Findings
- Large numbers of newly settled surgeonfish (Ctenochaetus striatus) with white lesions lying dead on the sand amongst patch reefs following separate episodic settlement events in 2006 and 2009 in Moorea, French Polynesia.- Two separate episodic settlement events of the striped bristletooth, Ctenochaetus striatus (Acanthuridae), where settlers formed large schools that swarmed throughout the lagoon of Moorea, French Polynesia.- Hundreds of apparently diseased fish lying dead or dying on the lagoon floor.
...
## Key Findings
- This study demonstrates illegal shark fishing is an ongoing concern and that stricter enforcement and legislation is urgently needed, particularly in areas of high biodiversity.- Results demonstrated that either other predators will fill the ecological gap left by pelagic sharks.- This study demonstrates the urgent need for increased management and conservation for regional shark populations, particularly, amongst such ecologically rich ‘‘hotspots’’ like the GMR.- There were differences between juveniles and adults for either female or male silky sharks.
...
## Key Findings
- The timing of predator arrival can be as important as predator density in modifying prey abundance and community composition.- Hawkfish on 66 of the 192 surveyed patch reefs; we focus our analysis on 55 of the 66 reefs where hawkfish were observed at least twice.- No demonstrable effects of predator temporal variability.
...
## Key Findings
- Depletion of prey by predators in combination with a nonlinear functional response leads to conclusions of risk enhancement or risk reduction even when predators have independent effects.- The direction and magnitude of bias is in part a consequence of the experimental design.
...
## Key Findings
- Symbiont density is restricted by intraspecific competition.- Effects combined independently.- Results suggests there is no general Sediment Cleaning by Multiple Coral Mutualists PLoS ONE | www.- The abundance-diversity relationship extracted from papers on communities inhabitingPocillopora damicornis[43] (red - a),Stylophora pistillata[44] (green – b), and our study inPocillopora cf.
...
## Key Findings
- Significant decrease in the me 3 K27 H3 mark, but not in the me 3 K4 H3 mark that also correlated with a significant increase in expression of some genes involved in the regenerative response.- These findings suggest that nucleostemin may contribute to cell cycle reentry in other cell types, and supports a role for theInk4alocus in restricting de-differentiation in mammalian cells through multiple pathways.- These findings suggest an increased methylation in control regions of genes that participate in regeneration, and therefore may help explain the loss of regenerative ability following metamorphosis inX.
...
## Key Findings
- Up to five species ofTrapezia.- The multiplicative (log-link) model fitted the data worse than an analogous model using the standard logit link, because the logit-link model was better able to handle block–treatment combinations with high expected predation rates.- Evidence for synergy among exosymbionts in their ability to reduce the volume of coral tissue consumed.- We observed, we must acknowledge that these differences as well as the strength of the MDE may vary with host ontogeny, temporal scale of the experiment, and the degree to which species vary in recruitment.- Differences in the efficacy of defense provided by two coral mutualists.
...
## Key Findings
- There were differences of coral colony density on predator abundance.
...
## Key Findings
- Predation can alter diversity of reef fish communities by indiscriminately reducing the abundance of fishes soon after settlement, thereby reducing the number of species present on reefs.- These results indicate that predation can alter diversity of reef fish communities by indiscriminately reducing the abundance of fishes soon after settlement, thereby reducing the number of species present on reefs.
...
## Key Findings
- That, when competitors arrive simultaneously, competitive interactions are weak and subordinates are not displaced from complex habitat; increasing habitat complexity increases survival by disrupting predation.- This study demonstrates that the strength of competition can be context-dependent and may vary with the timing of competitive interactions and habitat complexity.- No immigrants or emigrants.- Strong aggression towards focal individuals by early-arriving competitors to the point that earlyarriving competitors pursued focal individuals across the entire reef.- The contexts within which interactions occur are important determinants of the strength of intraspecific competition.
...
## Key Findings
- In Moorea may also occur in other locations.- Results suggested that reef systems containing vermetids may trend towards domination by Montipora , which is less strongly affected by vermetids (though notably, also a comparatively slow3 growing coral).
...
## Key Findings
- This study shows that the strength of competition depends not only on the identity of competitors, but also on the sequence and timing of their interactions, suggesting that when examining interaction strengths, it is important to identify temporal variability in the direction and magnitude of their effects.- No immigrants or emigrants, and previous research has shown that small reef fish rarely move between reefs separated by as little as 15 m (Caselle 1999, Shima 2001).- Variability in the timing of settlement pulses ofT.- The strength of competitive effects was primarily related to relative arrival time and poorly explained by the identity of prior residents.- Order of arrival and not species identity to be important here, our results are more consistent with neutral processes structuring communities than niche-based theories.
