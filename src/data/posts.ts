...
export const posts: BlogPost[] = [
  {
    ...
    content: `We joined ecologists who have searched for decades for universal rules governing how animal populations grow and stabilize. One of the most fundamental assumptions is density dependence: as populations become crowded, competition and predation should intensify, pushing mortality rates higher and keeping populations in check. But when Craig Osenberg and I synthesized data from 56 studies spanning 38 reef fish species, we discovered something troubling—these rules don't apply consistently.
...
[Read the full paper](https://doi.org/10.1111/ele.70262)`,
  },
  {
    ...
    content: `We recognized that climate change is reshaping our oceans in ways that challenge everything we know about managing fisheries. As waters warm and ecosystems shift, fish populations are responding—sometimes thriving, sometimes struggling. For managers charged with both protecting fish stocks and supporting fishing communities, the question becomes urgent: how do we adapt?
...
[Read the full paper](https://doi.org/10.1007/s00338-025-02647-4)`,
  },
  {
    ...
    content: `Our research on the remarkable world of coral guard crabs reveals one of nature's most unlikely partnerships. These small Trapeziid crabs live their entire lives within the branches of cauliflower corals in the tropical Pacific, turning coral protection into a specialized art form.
...
*This paper is Open Access.*`,
  },
  {
    ...
    content: `We compared traditional measuring techniques to 3D photogrammetry and found significant comparing traditional measuring techniques to 3D photogrammetry found significant differences in how accurately each method captures coral growth and predicts biodiversity. The study, conducted on 60 Pocillopora coral colonies in Moorea, French Polynesia, revealed that over a third of manual measurements suggested corals were shrinking over a 105-day period, while photogrammetric skeletal measurements showed zero instances of negative growth.
...
[Read the full paper](https://doi.org/10.1111/1365-2656.13918)`,
  },
  {
    ...
    content: `Our research reveals something counterintuitive about how reefs recover from disasters. We, led by Kai Kopecky at UC Santa Barbara, wanted to understand why some reefs bounce back quickly from disturbances while others seem to get stuck in degraded states dominated by algae instead of coral.
...
*This paper is Open Access.*`,
  },
  {
    ...
    content: `We examined scientific traps in 2018 near the borders of California's Channel Islands marine reserves and found something remarkable. This wasn't just conservation success—it was evidence that protecting ocean areas could actually boost fisheries.
...
*This paper is Open Access.*`,
  },
  {
    ...
    content: `We addressed a major challenge in sustainability science: identifying targets that maximize ecosystem benefits to humanity while minimizing the risk of crossing critical system thresholds. Researchers led by Adrian Stier at UC Santa Barbara tackled a deceptively simple question: how much monitoring is enough?
...
*This paper is Open Access.*`,
  },
  {
    ...
    content: `We tested an intuitive idea: coral reefs far from human civilization should be better protected from our influence. But when researchers led by Justin Baumann, working with Lily Zhao, Adrian Stier, and John Bruno, tested this assumption, they found something surprising.
...
*This paper is Open Access.*`,
  },
  {
    ...
    content: `We studied parrotfish behavior across Caribbean reefs and discovered that these critical reef cleaners behave dramatically differently depending on where they live—a finding that could change how we protect coral reefs.
...
*This paper is Open Access.*`,
  },
  {
    ...
    content: `We examined climate policy discussions around Green New Deal proposals, which have focused primarily on terrestrial solutions. We identified this as a significant missed opportunity given that oceans cover 71% of the planet's surface.
...
*This paper is Open Access.*`,
  },
  {
    ...
    content: `Our analysis of 65 years of Pacific herring data from Haida Gwaii reveals how a natural insurance system has eroded over time. We assembled records from 1950 to 2015 showing how Pacific herring populations across 11 locations around the British Columbia archipelago have fundamentally changed. What was once a portfolio of populations that boomed and busted at different times—providing reliable resources to predators and fishermen even when individual groups crashed—has become dangerously synchronized.
...
*This paper is Open Access.*`,
  },
  {
    ...
    content: `We examined how dispersal—the movement of organisms between habitat patches—profoundly influences biodiversity patterns. But research by Adrian Stier, Shannon Lee, and Mary O'Connor reveals that when dispersal happens may be just as important as how much dispersal occurs.
...
*This paper is Open Access.*`,
  },
  {
    ...
    content: `We found that marine conservation typically tackles one species or fishery at a time—protect the cod, restore the sharks, manage the herring. Protect the cod. Restore the sharks. Manage the herring. But research by Jameal Samhouri, Adrian Stier, Shannon Hennessey, Mark Novak, Benjamin Halpern, and Phillip Levin suggests this piecemeal approach may be missing a faster path to recovery.
...
*This paper is Open Access.*`,
  },
  {
    ...
    content: `Our meta-analysis of ten predation experiments on coral reefs reveals how mesopredators affect the diversity of young reef fish communities. We analyzed every published field experiment where researchers had manipulated predator presence on artificial reefs and tracked what happened to recruiting fish communities.
...
*This paper is Open Access.*`,
  },
  {
    ...
    content: `Our research examines how different ways of fishing Pacific herring affect both the fish populations and the predators that depend on them for food. Along the coasts of British Columbia and Alaska, fishers target the same herring populations in two completely different ways: some catch spawning adults, while others harvest the eggs those adults produce.
...
*This paper is Open Access.*`,
  },
  {
    ...
    content: `Our research reveals how predatory fish affect the tiny, hidden creatures living inside coral colonies. We found that predators dramatically reduce the abundance and diversity of beneficial animals that help corals survive.
...
[Read the full paper](https://doi.org/10.1007/s00338-013-1096-z)`,
  },
  {
    ...
    content: `We wanted to understand how predators and habitat characteristics interact to shape fish populations on coral reefs.
...
[Read the full paper](https://doi.org/10.1890/12-1441.1)`,
  },
  {
    ...
    content: `We mapped predator-to-prey ratios across Pacific coral reefs, expecting to see clear patterns. Instead, they found the opposite. The most remote reefs—places like Midway and Tuvalu—had three times as many predator species per prey species as reefs near large landmasses like Palau and Vanuatu.
...
[Read the full paper](https://doi.org/10.1016/j.marpol.2012.12.005)`,
  },
  {
    ...
    content: `We investigated whether competition between multiple species follows predictable mathematical patterns. Research by Shane Geange, Adrian Stier, and Jeffrey Shima tested this question among juvenile coral reef wrasses.
...
*This paper is Open Access.*`,
  },
  {
    ...
    content: `We studied predation on coral reefs and discovered that timing matters as much as size when it comes to survival.
...
[Read the full paper](https://doi.org/10.1890/11-1983.1)`,
  },
  {
    ...
    content: `We witnessed something extraordinary in February 2006 in the lagoons of Moorea: striped bristletooth surgeonfish had arrived as juveniles in an episodic settlement event. Within days, hundreds of these fish were lying dead on the sandy bottom, their bodies marked by distinctive white lesions.
...
[Read the full paper](https://doi.org/10.1007/s00442-012-2275-2)`,
  },
  {
    ...
    content: `We examined one of the most compelling questions in evolutionary biology: why some animals can regenerate injured structures while others cannot.
...
[Read the full paper](https://doi.org/10.1111/j.1469-185X.2011.00199.x)`,
  },
  {
    ...
    content: `We studied coral reefs in French Polynesia and discovered that corals with four clearly separated clades of their symbiotic algae responded differently to temperature stress than those with mixed populations.
...
[Read the full paper](https://doi.org/10.1007/s00338-010-0694-2)`,
  },
  {
    ...
    content: `We studied young wrasse settling onto coral reefs in the lagoons of Moorea, French Polynesia.
...
[Read the full paper](https://doi.org/10.1007/s00442-009-1554-z)`,
  },
  {
    ...
    content: `We wanted to understand how fish populations naturally fluctuate on coral reefs—specifically, what controls how many young fish survive their first vulnerable weeks after settling onto the reef.
...
[Read the full paper](https://doi.org/10.1007/s00338-010-0606-5)`,
  },
  {
    ...
    content: `We examined how predators affect young coral-dwelling fish during their critical first weeks on the reef.
...
*This paper is Open Access.*`,
  },
  {
    ...
    content: `We studied coral reef fish settlement in French Polynesia and discovered that baby fish arriving on reefs face an immediate gauntlet of predators.
...
[Read the full paper](https://doi.org/10.1890/09-1993.1)`,
  },
  {
    ...
    content: `We transplanted coral colonies onto patch reefs in Moorea's lagoon and discovered something unexpected. In their 40-day experiment, corals with their crab bodyguards thrived even when surrounded by mucus-producing vermetid snails, while those without crabs suffered dramatic growth reductions.
...
[Read the full paper](https://doi.org/10.1016/j.jembe.2008.10.020)`,
  },
  {
    ...
    content: `We examined competition on coral reefs requires looking beyond which species arrive to consider when they arrive. Research on two wrasse species in French Polynesia reveals how timing of arrival affects competitive outcomes among young reef fish.
...
[Read the full paper](https://doi.org/10.1890/08-0630.1)`,
  },
  {
    ...
    content: `We documented reef fish using crown-of-thorns starfish as habitat. While surveying starfish in Moorea, we repeatedly observed small fish sheltering among the venomous spines. The creature famous for destroying coral habitat was serving as habitat itself.
