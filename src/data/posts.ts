...
*This paper is Open Access.*`,
  },
  {
    ...
    content: `The idea seems intuitive: coral reefs far from human civilization should be better protected from our impacts and therefore more resilient to climate change. But when researchers led by Justin Baumann, working with Lily Zhao, Adrian Stier, and John Bruno, tested this assumption, they found something surprising.

The team analyzed the relationship between local human influence and coral community resilience across reefs worldwide. They measured both resistance to disturbance and recovery rates following bleaching, disease, storms, and predator outbreaks. The results challenged a fundamental assumption in coral conservation.

Remote coral reefs showed no enhanced resilience compared to those near human populations. In fact, some evidence suggested reefs in more developed areas recovered from disturbances faster than their isolated counterparts. The researchers found no relationship between human influence and resistance to disturbance.
...
*This paper is Open Access.*`,
  },
  {
    ...
    featuredImage: "/images/researcher-on-boat-ocean-fieldwork.jpg",
...
[Read the full paper](https://doi.org/10.1111/ele.13571)`,
  },
  {
    ...
    content: `Look at satellite images of tropical coastlines and you'll notice something curious: rings of bare sand surrounding coral reef patches, like protective moats. These grazing halos, sometimes stretching tens of meters from reef edges, have puzzled scientists for years. Now research led by Bryan DiFiore, working with Simon Queenborough, Elizabeth Madin, Valerie Paul, Mary Beth Decker, and Adrian Stier, reveals the ecological drama creating these patterns.
...
The research team combined satellite imagery with underwater surveys to understand what factors determine halo size. They found that predation risk, herbivore density, and reef patch size all influence how far fish will venture from safety. Counterintuitively, halos were often larger around reefs with more predators. The researchers suggest this occurs because in predator-rich areas, herbivores must graze more intensively in the safe zone close to the reef, completely clearing vegetation there.
...
[Read the full paper](https://doi.org/10.3354/meps13074)`,
  },
  {
    ...
    featuredImage: "/images/squid-silhouette-blue-ocean.JPG",
...
*This paper is Open Access.*`,
  },
  {
    ...
    content: `Ecologists have long understood that dispersal, the movement of organisms between habitat patches, plays a crucial role in maintaining biodiversity. But research by Adrian Stier, Shannon Lee, and Mary O'Connor reveals that when dispersal happens may be just as important as how much dispersal occurs.

The team created experimental seagrass metacommunities, networks of connected habitat patches, and manipulated both the rate and temporal pattern of dispersal between patches. Some treatments received constant low-level dispersal, while others received equivalent total dispersal concentrated into pulses. This allowed them to separate the effects of dispersal amount from dispersal timing.
...
These findings have important implications for marine conservation. As coastal habitats become increasingly fragmented by development, understanding what maintains diversity in disconnected patches becomes crucial. Conservation strategies often focus on maintaining or restoring connectivity between habitat patches, but this research suggests the pattern of that connectivity matters too.
...
[Read the full paper](https://doi.org/10.3354/meps12908)`,
  },
  {
    ...
    content: `Why do some habitat patches consistently harbor more organisms than others, even when they seem identical in quality? Research by Elizabeth Hamman, Scott McKinley, Adrian Stier, and Craig Osenberg reveals that the answer lies in geometry: the spatial arrangement of patches creates invisible channels that funnel colonizers toward certain locations.

The team developed mathematical models to explore how organisms moving through a landscape interact with the configuration of habitat patches. They focused on systems where colonizers arrive from a larger pool, like fish larvae settling onto reef patches or insects colonizing forest fragments.
...
[Read the full paper](https://doi.org/10.1016/j.marpol.2016.11.011)`,
  },
  {
    ...
    featuredImage: "/images/beach-sunset-sea-lion-silhouette.jpg",
...
The approach isn't without challenges. Different knowledge systems use different evidence standards, time scales, and ways of describing ecological relationships. The researchers developed methods to translate across these frameworks while respecting the integrity of each knowledge type.

As marine ecosystems face unprecedented change from climate warming and shifting species distributions, the ecological knowledge accumulated over generations by Indigenous communities and local resource users becomes increasingly valuable. This research demonstrates practical methods for honoring and integrating that knowledge into conservation planning.
...
[Read the full paper](https://doi.org/10.1007/s00338-013-1077-2)`,
  },
  {
    ...
    content: `Ecologists often assume predators act independently: if one shark eats ten fish per day, two sharks should eat twenty. But on coral reefs, research by Adrian Stier and Wilson White reveals this simple math doesn't hold. When predators cluster on the same patch of reef, each individual becomes a less effective hunter.

The team conducted experiments manipulating the density of predatory fish on coral reef patches. By controlling predator numbers and measuring how many prey each consumed, they could calculate what ecologists call the functional response: the relationship between prey availability and predation rate. Their focus was on how this relationship changed when multiple predators hunted the same area.

The results showed clear predator interference. Per-capita predation rates declined as predator density increased. A single predator consumed prey at a higher rate than the same predator would achieve when hunting alongside others. Multiple predators together caught fewer total prey than you'd predict by multiplying single-predator rates.
...
[Read the full paper](https://doi.org/10.1007/s00442-012-2275-2)`,
  },
  {
    ...
    content: `One of the most compelling questions in evolutionary biology is why some animals can regenerate injured structures while others cannot. Salamanders can regrow entire limbs, sea stars can regenerate arms, and some fish can replace fins, yet mammals and birds have largely lost this ability. In a comprehensive review, researchers led by Ashley Seifert, including Adrian Stier and colleagues, examined the fundamental traits that influence this remarkable capacity.

The team synthesized decades of research across the animal kingdom, looking for patterns that might explain the patchy distribution of regenerative ability. What emerged was a complex picture where regeneration isn't simply present or absent, but varies in degree and changes throughout an animal's life. Within single species, regenerative capacity often declines with age and body size, or can be lost entirely during major life transitions.
...
Predator behavior adds another layer of complexity. If predators focus their hunting on areas of high prey density, this generates strong density-dependent mortality. But if predators are territorial and spread their effort evenly across space, density dependence weakens. The researchers showed how these behavioral mechanisms interact with habitat to produce the variable patterns seen in field studies.
...
[Read the full paper](https://doi.org/10.1016/j.jembe.2008.10.020)`,
  },
  {
    ...
    featuredImage: "/images/garibaldi-fish-orange-kelp-forest.jpeg",
